...
\begin{figure}[H]
  ...
  \end{minipage}
  \caption{SAE training convergence. Top: ViT-B/16 (Layers~2/9/10/11) converges stably to $R^2$ between $0.68$ and $0.89$ with non-trivial sparsity. Bottom: DINOv2-B under the identical recipe, where only Layer~9 trains to a high $R^2$, while Layers~2/10/11 collapse ($\bar{L}_0\!\to\!0$, $R^2\!\le\!0.09$), the signature of an over-sparsified, dead dictionary.}
