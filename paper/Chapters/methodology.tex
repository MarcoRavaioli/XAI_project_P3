...
This design targets sparse feature decomposition on patch-token representations; explicit tracing of how patch evidence is aggregated into \texttt{[CLS]} is outside the present scope.
